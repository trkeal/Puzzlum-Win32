...
"C:\Program Files (x86)\FreeBASIC\fbc64.exe" "fbimage.bas" -lib >> "compile-win64.log"

"C:\Program Files (x86)\FreeBASIC\fbc64.exe" "clv.bas" -lib >> "compile-win64.log"

copy "*.a" "C:\Program Files (x86)\FreeBASIC\lib\win64\*.a" >> "compile-win64.log"
